<aside id="layout-menu" class="layout-menu menu-vertical menu">
    <div class="app-brand demo py-3 px-2 border-bottom">
        ...
        <a href="{{ route('user.index') }}" class="app-brand-link d-flex align-items-center text-decoration-none">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ Route::is('user.download') ? 'active' : '' }}">
            <a href="{{ route('user.download') }}" class="menu-link text-decoration-none">
